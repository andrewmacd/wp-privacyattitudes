...
gm.index.q <- privacy %>% 
  select(`Government monitoring index inc biometric` = gm.index.gov.inc.track,
         `Private monitoring index inc biometric` = gm.index.priv.inc.track,
...
```{r}
#| label: tbl-gp-model
#| tbl-cap: "Government performance model"
