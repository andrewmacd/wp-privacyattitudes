...
datasummary_balance(`Number of items selected` ~ Shown,
                    data=police.qs,
...
datasummary_balance(`Number of items selected` ~ Shown,
                    data=centralgov.qs,
                    title="Central government trust list experiment")
...
datasummary_balance(`Number of items selected` ~ Shown,
                    data=localgov.qs,
                    title="Local government trust list experiment")
